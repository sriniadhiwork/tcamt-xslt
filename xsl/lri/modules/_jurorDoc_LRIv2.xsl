...
<xsl:stylesheet version="2.0" xmlns:xhtml="http://www.w3.org/1999/xhtml"
                        ...
                        <tr>
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="exists($testName/OBR/OBR.4/OBR.4.9)">
                                    <td colspan="10" width="75%" style="font-weight:bold; color:red">
                        ...
                        <tr>
                            <th> OBR-4 <xsl:if
                                    test="
                                        ...
                                        or ($messageID = 'LRI_5.0_2.1-GU_FRU') or ($messageID = 'LRI_5.1_2.1-GU_FRN') or ($messageID = 'LRI_5.0_2.1-NG_FRU') or ($messageID = 'LRI_5.1_2.1-NG_FRN')">
    ...
    <xsl:template name="resultInfo-IV">
        ...
        <fieldset id="ResultInfo-IV">
            <xsl:for-each select="$obxSegment/OBX">
        ...
        <xsl:if test="$message-type = $ORU_R01">
            ...
            <xsl:if
                ...
                <xsl:call-template name="orderInfocontd_child-IV">
                    <xsl:with-param name="obrSegment"
                        select="//ORU_R01.PATIENT_RESULT.ORDER_OBSERVATION"/>
                    <xsl:with-param name="er7XMLMessage" select="$er7XMLMessage"/>
                    <xsl:with-param name="messageID" select="$messageID"/>
                </xsl:call-template>
